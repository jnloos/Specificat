@props(['expert', 'project'])
{
    ...
    "required_output_format": {
        "description": "You MUST output a flat JSON object containing exactly the keys `statement` and `importance`.",
        "output_example": {
        ...
        "validation_rules": [
            ...
            "The output MUST contain exactly two keys: 'statement' (string) and 'importance' (integer).",
