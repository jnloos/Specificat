...
"output_schema": {
"<expert_id>": {
    "statement": "Expert's next contribution phrased in the first person, focusing on user stories, features, goals, or requirements (not implementation details). The message should sound natural, avoid repeated filler phrases, and may include short confirmations or clarifying questions to other experts.",
    "importance": "Score 1–10 integer, determined by: (1) if the expert has already spoken recently, lower the score; (2) weight and relevance of the content; (3) importance of the expert’s role; (4) how often the expert has spoken so far; (5) whether the message fits naturally into the context without being out-of-place; (6) occasional short confirmations or clarifying questions should also receive higher priority to keep the dialogue authentic."
    }
    }
    }
