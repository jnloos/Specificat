@php
    // Ensure data is properly formatted for JSON embedding
    $contextData = [
        ...
        "message_history" => $messages_section
    ];
...
@endphp
{
  ...
  "context": {!! json_encode($contextData, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT) !!},
  ...
  "required_output_format": {!! json_encode($requiredOutputData, JSON_UNESCAPED_SLASHES | JSON_PRETTY_PRINT) !!}
}
