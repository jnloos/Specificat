...
class GeminiClient implements LLMClient
{
    ...
    public function __construct() {
        ...
        $this->pythonPath = config('gemini.python_path', 'python3');
    }
    ...
    public function getUserSummary(array $project, array $experts): array {
        ...
        $jsonInput = json_encode($payload, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
        $jsonOutput = $this->pythonVenv->exec('gemini-clients/user_summary_gen.py', [$jsonInput]);
         ...
         * Output JSON ← summary_gen.py
         * {
         *   "summary": "Global summary of the current descussion"
         * }
         */
